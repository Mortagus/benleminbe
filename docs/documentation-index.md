...
- [Workflow de développement](development-workflow.md) : contrat léger pour les backlogs, tickets, reprises et clôtures.
...
- [Musique privee](private/music/music-index.md) : module prive d'analyse de l'historique Spotify, de synchronisation externe et de generation future de playlists.
