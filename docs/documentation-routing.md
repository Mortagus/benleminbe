...
| Comment créer, démarrer ou reprendre un ticket ?     | `development-workflow.md`, puis le backlog du domaine concerné | La tâche Backlog.md                                                            | Workflow de développement             |
