...
| 33              | P33 | Plus tard         | Plus tard             | Règles / Joueurs           | DEX des joueurs saisis à la main                         | Ajouter une saisie de DEX ou de modificateur d'initiative pour les joueurs créés manuellement, afin que le départage d'égalité par DEX fonctionne pour tout le monde.             | Complète `P24` sans dépendre de l'import XML ; à brancher dans le formulaire joueur, la validation et la persistance.          |
