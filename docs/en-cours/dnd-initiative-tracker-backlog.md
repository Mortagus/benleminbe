...
| 17              | P24 | Moyenne           | Partiel               | Règles                     | Gestion explicite des égalités d'initiative              | Règle optionnelle désactivée par défaut : départager les égalités par modificateur de DEX, avec joueurs à `0` pour l'instant.    | Gestion de la DEX des joueurs à confirmer ; réordonnancement manuel disponible en fallback.                                    |
| 18              | P25 | Haute             | À faire               | UX                         | Différenciation visuelle des types d'acteurs             | Distinguer joueurs, alliés, ennemis, boss ou monstres légendaires avec des classes visuelles sobres.                             | À faire après stabilisation du rendu des cartes.                                                                               |
