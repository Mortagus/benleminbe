...
| `[data-player-field="side"]`               | Camp du participant, utilisé pour distinguer `party`, `ally`, `hostile` et `neutral`. |
...
| `[data-player-label="side"]`               | Label associé au camp.                                                                |
...
| `.turn-order-item__badges`          | Conteneur du badge boss.                                          |
| `.turn-order-item__legendary-badge` | Badge affiché pour un monstre légendaire.                         |
