...
| Template du jeu         | [`templates/lab/games/simon.html.twig`](/var/www/projects/benleminbe/templates/lab/games/simon.html.twig)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Porte la structure HTML, les `data-*`, le JSON de configuration et les textes traduits.                                        |
...
| `data-simon-board`                 | Conteneur des quatre pads.                                                                                    |
| `data-simon-pad`                   | Bouton d'une zone de jeu.                                                                                     |
| `data-simon-status`                | Annonce textuelle de l'état du jeu.                                                                           |
| `data-simon-level`                 | Niveau courant.                                                                                               |
| `data-simon-best`                  | Meilleur score local.                                                                                         |
| `data-simon-sound`                 | Bouton mute/unmute.                                                                                           |
